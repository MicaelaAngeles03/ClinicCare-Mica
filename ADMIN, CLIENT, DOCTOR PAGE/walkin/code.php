...
if(isset($_POST['delete_walkins']))
{
    ...
    $query = "DELETE FROM walkins WHERE id='$walkins_id'";
...
if (isset($_POST['update_walkins'])) {
    ...
    $query = "SELECT COUNT(*) as count FROM walkins WHERE email = '$email' AND id != '$walkins_id'";
    ...
    $query = "UPDATE walkins SET firstname='$firstname', middlename='$middlename', lastname='$lastname', birthdate='$birthdate',email='$email',contact_number='$contact_number',gender='$gender',address='$address'";
...
if (isset($_POST['save_walkins'])) {
    ...
    // Check if email is unique before proceeding
    $query = "SELECT COUNT(*) as count FROM walkins WHERE email = '$email'";
    $result = mysqli_query($con, $query);
    ...
    if (!in_array($gender, ['Male', 'Female'])) {
        ...
        $query = "INSERT INTO walkins (firstname, middlename, lastname, birthdate, email, contact_number, gender, address) VALUES ('$firstname', '$middlename', '$lastname', '$birthdate', '$email', '$contact_number', '$gender', '$address')";
        $query_run = mysqli_query($con, $query);
...
if (isset($_GET['walkins_id'])) {
    ...
    $query = "SELECT * FROM walkins WHERE id='$walkins_id'";
    $query_run = mysqli_query($con, $query);
