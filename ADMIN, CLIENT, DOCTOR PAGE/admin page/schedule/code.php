...
if (isset($_POST['update_schedule'])) {
    ...
    $query = "UPDATE schedule SET  start_time='$start_time',end_time='$end_time'";
...
if (isset($_POST['save_schedule'])) {
    ...
    $query = "SELECT COUNT(*) as count FROM schedule WHERE end_time = '$end_time'";
    ...
    if ($count > 0) {
        ...
        $query = "INSERT INTO schedule ( start_time, end_time) VALUES ('$start_time', '$end_time')";
    }
