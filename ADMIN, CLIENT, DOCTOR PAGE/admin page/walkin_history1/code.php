...
if(isset($_POST['delete_walkin_history']))
{
    ...
    $query = "DELETE FROM walkin_history WHERE id='$walkin_history_id'";
...
if (isset($_POST['update_walkin_history'])) {
    ...
    $query = "UPDATE walkin_history SET medical_history='$medical_history', eye_history='$eye_history', date_held='$date_held', service='$service' ,doctor='$doctor',findings='$findings',diagnosis='$diagnosis',prescription='$prescription'";
...
if (isset($_POST['save_walkin_history'])) {
    ...
    $query = "INSERT INTO walkin_history (patient_ID, medical_history, eye_history, date_held, service, doctor, findings, diagnosis, prescription) 
...
if (isset($_GET['walkin_history_id'])) {
    ...
    $query = "SELECT * FROM walkin_history WHERE id='$walkin_history_id'";
    $query_run = mysqli_query($con, $query);
