                        ...
                        <?php
                            $employee_array = array(
                                ...
                                array(
                                    ...
                                    'date' => '12/10/23',
                                    'time' => '14:00-15:00',
                                    'status' => '<div class="d-flex align-items-center gap-3"><button type="button" class="btn btn-success"><i class="fa fa-check"></i> Approved</button><button type="button" class="btn btn-danger mr-2"><i class="fa fa-trash"></i> Cancel</button></div>'
